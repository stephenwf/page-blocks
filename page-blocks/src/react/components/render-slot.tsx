import { BlockConfig, blockSymbol, DirectoryOptions, SlotResponse } from '../../core';
  ...
  return (
    <pb-slot key={slot.id} {...editorProps}>
      {blocks.map((block: any, k: number) => {
        ...
        // const RenderBlockComponent = isEditingSlot && current.blockId === block.id ? RenderPreviewBlock : RenderBlock;
