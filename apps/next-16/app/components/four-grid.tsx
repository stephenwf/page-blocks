...
export const FourGrid = block(
  ...
  function FourGrid(props) {
    ...
    const gridClassName = `grid grid-cols-1 sm:grid-cols-2 ${cols} gap-4 items-center justify-center pb-grid-slot`;
    return (
      <div className="mt-12 mb-24">
        {props.title ? <h3 className="text-slate-800 text-3xl my-12 text-center">{props.title}</h3> : null}
