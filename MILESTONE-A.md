...
Milestone A is complete when `pnpm verify:package` passes from a clean `dist/`, CI invokes that gate, and the regression/conformance tests cover each item above.
